...
def createDatabase():
    ...
    restaurantDict = {
        ...
        "sandwichList": ['Subway', 'Jersey Mikes', 'Penn Station', 'Firehouse Subs', 'The Sub Station', 'Magic Subs & Gyros', "Mr. Zub's Deli", 'Corral Sanwich Shop', 'Hanini Subs', "Jimmy John's"],
